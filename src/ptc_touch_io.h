...
typedef struct PTC_struct {
  ...
  register8_t XBM;            /* 0xE8 X Channel bitmask */
  register8_t XBM_pad[7];     /* 0xE9 X Channel bm padding (last two unwritable) */
  register8_t YBM;            /* 0xF0 Y Channel bitmask */
  register8_t YBM_pad[7];     /* 0xF1 Y Channel bm padding */
